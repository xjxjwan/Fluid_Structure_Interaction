...
std::vector<std::array<double, 4>> halfTimeStepUpdateX(const std::array<double, 4>& uBarL,
    const std::array<double, 4>& uBarR, const double& dx, const double& dt, const double& gama, const double& p_inf);

// 声明 halfTimeStepUpdateY 函数
std::vector<std::array<double, 4>> halfTimeStepUpdateY(const std::array<double, 4>& uBarD,
    const std::array<double, 4>& uBarU, const double& dy, const double& dt, const double& gama, const double& p_inf);
